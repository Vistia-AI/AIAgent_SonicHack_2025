...
POST_TWEET_PROMPT = ("Generate a tweet, keep it under 280 characters."
                     "Analyze the current market trend." 
                    "Based on real-time data from the last 14 time intervals:" )
                    

REPLY_TWEET_PROMPT = (
                    "Generate a friendly, engaging reply to this tweet: {tweet_text}. Keep it under 280 characters."
                    "Craft a thoughtful and insightful reply to a tweet in the crypto space. "
                    "Add value by providing analysis, clarifications, or alternative viewpoints. "
                    "If the tweet is about breaking news, summarize the impact. "
                    "If it's a question, give a clear and knowledgeable answer. "
